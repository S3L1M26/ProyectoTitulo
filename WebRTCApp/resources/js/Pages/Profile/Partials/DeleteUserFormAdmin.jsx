...
export default function DeleteUserFormAdmin({ className = '', allUsers }) {
    ...
    const deleteUser = (e) => {
        ...
        destroy(route('admin.users.destroy', {id: data.user_id}), {
            preserveScroll: true,
            onSuccess: () => closeModal(),
            onError: () => {
                passwordInput.current.focus();
                user_idInput.current.focus();
            },
            onFinish: () => reset(),
        });
    };
        ...
        <section className={`space-y-6 ${className}`}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    Una vez que se elimine la cuenta, todos sus recursos y datos
                    serán eliminados permanentemente. Antes de eliminar la cuenta,
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        Una vez que se elimine la cuenta, todos sus recursos y
