...
class AreasInteresSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $areas = [
            ...
            ['nombre' => 'Desarrollador Full Stack', 'descripcion' => 'Dominio de frontend y backend para construir aplicaciones end-to-end.', 'roadmap_url' => 'https://roadmap.sh/full-stack'],
            ...
            ['nombre' => 'Ingeniería de Datos', 'descripcion' => 'Construcción de pipelines y plataformas de datos escalables.', 'roadmap_url' => 'https://roadmap.sh/data-engineer'],
            ...
            ['nombre' => 'Diseño UX/UI', 'descripcion' => 'Diseño de interfaces de usuario y experiencia de usuario centrada en usabilidad.', 'roadmap_url' => 'https://roadmap.sh/ux-design'],
            ...
            ['nombre' => 'Administrador de PostgreSQL (DBA)', 'descripcion' => 'Administración experta de bases de datos PostgreSQL.', 'roadmap_url' => 'https://roadmap.sh/postgresql-dba'],
            ['nombre' => 'Desarrollo iOS', 'descripcion' => 'Desarrollo de aplicaciones para el ecosistema Apple iOS.', 'roadmap_url' => 'https://roadmap.sh/ios'],
            ['nombre' => 'Aprendizaje Automático (ML)', 'descripcion' => 'Aplicación de algoritmos de aprendizaje para resolver problemas.', 'roadmap_url' => 'https://roadmap.sh/machine-learning'],
            ['nombre' => 'Redactor Técnico', 'descripcion' => 'Redacción técnica para documentación de productos y APIs.', 'roadmap_url' => 'https://roadmap.sh/technical-writer'],
            ['nombre' => 'Desarrollador de Videojuegos', 'descripcion' => 'Desarrollo de videojuegos en distintas plataformas.', 'roadmap_url' => 'https://roadmap.sh/game-developer'],
            ['nombre' => 'Desarrollador de Videojuegos (Servidor)', 'descripcion' => 'Backends y servidores para juegos online.', 'roadmap_url' => 'https://roadmap.sh/server-side-game-developer'],
            ['nombre' => 'MLOps', 'descripcion' => 'Operacionalización de modelos de ML en producción.', 'roadmap_url' => 'https://roadmap.sh/mlops'],
            ['nombre' => 'Gestor de Ingeniería (Engineering Manager)', 'descripcion' => 'Liderazgo técnico y gestión de equipos de ingeniería.', 'roadmap_url' => 'https://roadmap.sh/engineering-manager'],
            ['nombre' => 'Relaciones con Desarrolladores (DevRel)', 'descripcion' => 'Relación con desarrolladores y evangelización técnica.', 'roadmap_url' => 'https://roadmap.sh/devrel'],
            ['nombre' => 'Analista de BI', 'descripcion' => 'Análisis de negocio con inteligencia de datos.', 'roadmap_url' => 'https://roadmap.sh/bi-analyst'],
        ];
